<template>
    <div class="container" style="margin-top: 3rem;">
      ...
      <ul>
          <li>Arctica is built in Rust on top of <a href="https://github.com/bicoindevkit">BDK</a>. The <a href="https://github.com/wild-kard/arctica-frontend">Front End Repo</a> is built with Vue.js and runs as a standalone desktop application through tauri which emulates web view without requiring the use of a browser.</li>
