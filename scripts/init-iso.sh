...
#symlink chainstate
sudo ln -s /media/ubuntu/$UUID/.bitcoin/chainstate /media/$USER/writable/upper/home/ubuntu/.bitcoin/chainstate 
#symlink blockdata
sudo ln -s /media/ubuntu/$UUID/.bitcoin/blocks /media/$USER/writable/upper/home/ubuntu/.bitcoin/blocks
#download mkusb deps
